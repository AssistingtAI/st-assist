...
工作目录：C:\Users\xiaot\WorkBuddy\2026-05-16-task-2（GitHub Pages: **assistingtai.github.io/st-assist/**；2026-09-11 GitHub账号 Zsheng007→**AssistingtAI** + 仓库名 baokeng-ranking→**st-assist**（API PATCH改名）；旧 zsheng007.github.io/baokeng-ranking 均已404不重定向）
